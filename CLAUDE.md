...
Load (upload to the project): identity.md · rules.md · output-contract.md · examples.md · README.md · reference/INDEX.md · reference/pt/excerpts/ (all files) · reference/en/excerpts/ (all files) · reference/tables/required-fields.md · reference/tables/TABLES.md · reference/tables/working/ (the two CSV) · reference/tables/municipal-rates_2800308-aracaju-se_extract-20260903.csv · reference/tables/official/csv/ (all files).
