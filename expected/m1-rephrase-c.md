...
|---|---|---|---|---|---|---|
| m1-rephrase-c | 1-código | LC116 list item 17 | FALHA | corrigir antes de fechar | DPS/infDPS/serv/cServ/cTribNac = 010101 (profile: item 17.19) | 17.19 – Contabilidade, inclusive serviços técnicos e auxiliares. |
| m1-rephrase-c | 1-descrição | LC116 art. 1 | NÃO DÁ PARA DETERMINAR | — | DPS/infDPS/serv/cServ/xDescServ = "Assessoria contábil mensal conforme contrato. Valor R$ 400,00." | tem como fato gerador a prestação de serviços constantes da lista anexa |
