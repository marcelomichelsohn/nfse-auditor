...
| nfse-01.xml | 5-aritmética · as contas da nota (serviço, deduções, retenções, líquido) | LC116 art. 7 | PASSA | — | infNFSe/valores/vISSQN = 8.00 (vBC 400.00 × 2,00% implied; vLiq 400.00 = vServ) | A base de cálculo do imposto é o preço do serviço. |
| nfse-01.xml | 5-alíquota · alíquota de ISS que a nota mostra | LC123 art. 18 §22-A | NÃO SE APLICA | — | infNFSe/valores/vISSQN = 8.00 (2,00% on the note vs 5% in the municipal table: optant, accounting society — fixed ISS) | recolherá o ISS em valor fixo, na forma da legislação municipal. |
