...
|---|---|---|---|---|---|---|
| nfse-02.xml | 1-código · código de serviço da nota comparado com o item do cadastro | LC116 list item 17 | NÃO DÁ PARA DETERMINAR | — | DPS/infDPS/serv/cServ/cTribNac = 171901 (code exists in ANEXO B; no profile line to compare the item with) | 17.19 – Contabilidade, inclusive serviços técnicos e auxiliares. |
...
| nfse-02.xml | 4 · marcações do Simples Nacional comparadas com o regime do cadastro | LC123 art. 13 | NÃO DÁ PARA DETERMINAR | — | DPS/infDPS/prest/regTrib/opSimpNac = 3 (flags coherent among themselves; no profile line to confirm the regime) | VIII - Imposto sobre Serviços de Qualquer Natureza |
| nfse-02.xml | 5-aritmética · as contas da nota (serviço, deduções, retenções, líquido) | LC116 art. 7 | PASSA | — | infNFSe/valores/vISSQN = 8.00 (vBC 400.00 × 2,00% implied; vLiq 400.00 = vServ) | A base de cálculo do imposto é o preço do serviço. |
| nfse-02.xml | 5-alíquota · alíquota de ISS que a nota mostra | LC123 art. 18 §22-A | NÃO DÁ PARA DETERMINAR | — | infNFSe/valores/vISSQN = 8.00 (2,00% on the note vs 5% in the municipal table; whether the fixed-amount ISS applies depends on the regime, which the profile line would confirm) | recolherá o ISS em valor fixo, na forma da legislação municipal. |
