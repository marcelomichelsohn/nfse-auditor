...
| nfse-02.xml | 5-alíquota · alíquota de ISS que a nota mostra | LC123 art. 18 §22-A | NÃO DÁ PARA DETERMINAR | — | infNFSe/valores/vISSQN = 8.00 (implied 2,00% on this note; the municipal table would not apply to an optant; whether the fixed-amount ISS applies depends on the regime, which the profile line would confirm) | recolherá o ISS em valor fixo, na forma da legislação municipal. |
