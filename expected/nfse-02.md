...
| nfse-02.xml | 5-alíquota · alíquota de ISS que a nota mostra | LC123 art. 18 §22-A | NÃO SE APLICA | — | infNFSe/valores/vISSQN = 8.00 (2,00% on the note vs 5% in the municipal table: optant, accounting society — fixed ISS) | recolherá o ISS em valor fixo, na forma da legislação municipal. |
