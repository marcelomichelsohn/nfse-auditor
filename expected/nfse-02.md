...
**What was fed:** `fixtures/clean/nfse-02.xml` + the profile line `perfil: CNAE 6920-6/01; regime Simples optante; anexo fixo; município 2800308; item LC 116 17.19; exporta não`.
...
|---|---|---|---|---|---|---|
| nfse-02.xml | 1-código | LC116 list item 17 | PASSA | — | DPS/infDPS/serv/cServ/cTribNac = 171901 | 17.19 – Contabilidade, inclusive serviços técnicos e auxiliares. |
...
| nfse-02.xml | 4 | LC123 art. 13 | PASSA | — | DPS/infDPS/prest/regTrib/opSimpNac = 3 (regApTribSN = 1; tribISSQN = 1; tpRetISSQN = 1; profile: optante) | VIII - Imposto sobre Serviços de Qualquer Natureza |
...
| nfse-02.xml | 5-alíquota | LC123 art. 18 §22-A | NÃO SE APLICA | — | infNFSe/valores/vISSQN = 8.00 (2,00% on the note vs 5% in the municipal table: optant, accounting society — fixed ISS) | recolherá o ISS em valor fixo, na forma da legislação municipal. |
