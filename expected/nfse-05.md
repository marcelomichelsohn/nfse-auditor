...
|---|---|---|---|---|---|---|
| nfse-05.xml | 1-código · código de serviço da nota comparado com o item do cadastro | LC116 art. 1 | FALHA | corrigir antes de fechar · você decide antes de fechar | `DPS/infDPS/serv/cServ/cTribNac = 310101` (item 31.01) × perfil `Código de Atividade = 702` (item 7.02) | "a prestação de serviços constantes da lista anexa" |
